...
export const CHARACTER_RANDOM_REDEEMS_FREQUENCY_CHANGE = "characterRandomRedeemsFrequency"; // Random redeems frequency
export const CHARACTER_RANDOM_TALKING_FREQUENCY_CHANGE = "characterRandomTalkingFrequency"; // Random talking frequency
