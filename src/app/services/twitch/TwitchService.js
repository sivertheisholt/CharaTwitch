/**
 * @typedef {import("./twitchIrcService")} TwitchIrcService
 */
const twitchIrcService = require("./twitchIrcService");
/**
 * @typedef {import("./twitchApiService")} TwitchApiService
 */
const twitchApiService = require("./twitchApiService");
/**
 * @typedef {import("./twitchPubSubService")} TwitchPubSubService
 */
